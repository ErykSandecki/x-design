...
describe('useColumnAlignmentLayoutEvents', () => {
  it(`should return data`, () => {
    ...
    expect(result.current).toStrictEqual({
      ...
      isMixedColumnGapMode: false,
      isMixedColumnGapValue: false,
      isMixedColumnRowMode: false,
      isMixedColumnRowValue: false,
      isMixedLayout: false,
      layout: layoutMock,
      onBlurColumnGap: expect.any(Function),
      onBlurColumns: expect.any(Function),
      onBlurRowGap: expect.any(Function),
      onBlurRows: expect.any(Function),
