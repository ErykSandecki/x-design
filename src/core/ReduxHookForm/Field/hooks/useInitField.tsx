...
// store
import { initField } from 'store/reduxHookForm/slice';
...
export const useInitField = <V extends TFieldValue>(
  afterSubmit: TFunc | undefined,
  asyncValidators: Array<TAsyncValidator>,
  beforeSubmit: TFunc | undefined,
  data: TObject<any> | undefined,
  defaultValue: TFieldValue | undefined,
  fieldsToClearOnChange: Array<string>,
  formatOnBlur: TFunc<[V, string], V> | undefined,
  formatOnChange: TFunc<[V, string], V> | undefined,
  formatOnFocus: TFunc<[V, string], V> | undefined,
  formatOnInit: TFunc<[V], V> | undefined,
  name: string,
  parse: TFunc<[V, string], V> | undefined,
