---
name: x-design-module-structure
description: Where a type, constant, or utility function belongs inside a feature folder in x-design — types.ts vs constants.ts vs a utils/ folder, mirrored from x-design. Load before adding a new file to an existing feature folder (core/Routing, hooks/useX, translations, ...) or deciding where new code should live.
---
...
[[x-design-import-order]] — how imports from these files are grouped and ordered (`./types` **and**
...
categories).
[[x-design-test-conventions]] — how tests for these utils/hooks are structured.
