---
name: x-design-test-conventions
description: Unit test structure and step-comment convention for x-design, mirrored from x-design. Load before writing or reviewing any .spec.ts(x) file — covers describe/it naming and the // mock / // spy / // before / // find / // action / // wait / // result step comments.
---

# x-design Test Conventions
...
Both follow the nested `test/` placement from [[x-design-module-structure]] (components co-locate
...
See [[x-design-import-order]] for how the imports above these tests are ordered.
